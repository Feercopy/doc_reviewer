...
class Skill(TimestampMixin, Base):
    ...
    skill_source_id: Mapped[UUID | None] = mapped_column(Uuid(as_uuid=True), ForeignKey("skill_sources.id"), nullable=True)
    ...
    runtime_mode: Mapped[str] = mapped_column(String, nullable=False, default="snapshot_required")
